...
import { IPendlePriceCapAdapter, ICLSynchronicityPriceAdapter, IACLManager, AggregatorInterface } from 'src/contracts/interfaces/IPendlePriceCapAdapter.sol';
import { IPendlePrincipalToken } from 'src/contracts/interfaces/IPendlePrincipalToken.sol';
...
contract PendlePriceCapAdapter is IPendlePriceCapAdapter {
    ...
    /// @inheritdoc IPendlePriceCapAdapter
    AggregatorInterface public immutable ASSET_TO_USD_AGGREGATOR;
    ...
    constructor(PendlePriceCapAdapterParams memory params) {
        ...
        ASSET_TO_USD_AGGREGATOR = AggregatorInterface(params.assetToUsdAggregator);
